...
class ProductDetailswithParamWidget extends StatefulWidget {
  ...
  _ProductDetailswithParamWidgetState createState() =>
      _ProductDetailswithParamWidgetState();
}

class _ProductDetailswithParamWidgetState
    extends State<ProductDetailswithParamWidget> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    var med = Get.find<medicine_controller>().medicine_items[widget.pageId];
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                              ...
                                              child: Text(
                                                ...
                                                style:
                                                    TextStyle(fontSize: dimensions.size20),
                                              )),
                                          GestureDetector(
                                            onTap: () {
